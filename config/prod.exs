...
config :reading_list, MyAppWeb.Endpoint,
  url: [host: "whatareyoureading.tk", port: 443],
...
config :reading_list, :cert_path, "/home/corbi/site_encrypt_db"

# Set the cert mode so site_encrypt knows to hit live LetsEncrypt
config :reading_list, :cert_mode, "production"
